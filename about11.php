...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="../AboutUs/assets/img/apple-icon.png">
  ...
  <!-- CSS Files -->
  <link href="material-kit.css?v=2.0.4" rel="stylesheet" />
      ...
      <div class="section text-center">
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto">
            ...
            <h5 class="description">Help you figure out who you are and what you want out of your education, your career, and your life.<br>
...
group creator will help you all to create your own story.</h5>
      ...
      <div class="section text-center">
          ...
          <div class="row">
              ...
              <div class="team-player">
                <div class="card card-plain">
                  ...
                  <h4 class="card-title">Baldev
                    <br>
                    <small class="card-description text-muted">Desiger</small>
                  </h4>
                  <div class="card-body">
                    <p class="card-description">In this Project I worked as Front-end Desiger.</p>
                  </div>
              ...
              <div class="team-player">
                <div class="card card-plain">
                  ...
                  <h4 class="card-title">Ayush Arya
                    <br>
                    <small class="card-description text-muted">Designer/Coder</small>
                  </h4>
                  <div class="card-body">
                    <p class="card-description">In this Project I worked as Front-end Designer and Coder </p>
            ...
            <div class="col-md-4">
              <div class="team-player">
                <div class="card card-plain">
                  <div class="col-md-6 ml-auto mr-auto">
                    <img src="image/Dheeraj.PNG" alt="Thumbnail Image" class="img-raised rounded-circle img-fluid">
                  </div>
                  <h4 class="card-title">Dheeraj Raikwar
                    <br>
                ...
                <div class="team-player">
                  <div class="card card-plain">
                    ...
                    <h4 class="card-title">Bharat Badmera
                      <br>
                      <small class="card-description text-muted">Coder</small>
                    </h4>
                    <div class="card-body">
                      <p class="card-description">In this Project I worked as Back-end Designer and Coder.</p>
                    </div>
                    <div class="card-footer justify-content-center">
                      <a href="#pablo" class="btn btn-link btn-just-icon"><i class="fa fa-twitter"></i></a>
                      <a href="#pablo" class="btn btn-link btn-just-icon"><i class="fa fa-instagram"></i></a>
        ...
        <div class="sharing-area text-center">
          ...
          <a id="github" href="" target="_blank" class="btn btn-raised btn-github">
